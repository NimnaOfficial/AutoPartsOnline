...
<body>
    ...
    <section class="about-section">
        <div class="about-container">
            ...
            <div class="about-text">
                ...
                <br>
                <a href="contact.php" class="secondary-btn">Contact Our Team &rarr;</a>
            </div>
        </div>
    </section>
    ...
    <footer>
        <p>
            <a href="admin.php" style="text-decoration: none; color: inherit; cursor: text;" title="Admin Access">
                &copy;
            </a> 
